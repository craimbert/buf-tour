...
import (
    ...
    // petv1 "github.com/bufbuild/buf-tour/petstore/gen/proto/go/pet/v1" -- OLD
    petv1 "buf.build/gen/go/craimbert/petapis/protocolbuffers/go/pet/v1"
    "buf.build/gen/go/craimbert/petapis/grpc/go/pet/v1/petv1grpc"
